...
<jsp:useBean id="roles" scope="request" type="java.util.List<org.example.demo.model.Role>"/>
<jsp:useBean id="statuses" scope="request" type="java.util.List<org.example.demo.model.Status>"/>
<body>
