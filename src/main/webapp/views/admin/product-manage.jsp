...
<body>
<jsp:useBean id="brands" scope="request" type="java.util.List<org.example.demo.model.Brand>"/>
<jsp:useBean id="categories" scope="request" type="java.util.List<org.example.demo.model.Category>"/>
