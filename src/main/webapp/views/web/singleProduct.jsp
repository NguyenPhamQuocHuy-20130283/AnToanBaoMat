...
<jsp:useBean id="product" scope="request" type="org.example.demo.model.Product"/>
<jsp:useBean id="colors" scope="request"
             type="java.util.List<org.example.demo.model.Color>"/>
<jsp:useBean id="sizes" scope="request"
             type="java.util.List<org.example.demo.model.Size>"/>
